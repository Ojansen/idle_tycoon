...
const ALL: B[] = [
  // TYPE 0
  { id: 'mining_drone',     name: 'Mining Drone',      baseCost: 10,     cm: 1.045, out: 0.5,      res: 'cr',  tier: 0, cgUp: 0.025 },
  ...
  { id: 'solar_array',      name: 'Solar Array',       baseCost: 50,     cm: 1.045, out: 2.0,      res: 'en',  tier: 0, cgUp: 0.10 },
  ...
  // TYPE 1
  { id: 'asteroid_mine',    name: 'Asteroid Mine',     baseCost: 2e5,    cm: 1.045, out: 3000,     res: 'cr',  tier: 1, cgUp: 150 },
  ...
  { id: 'fusion_reactor',   name: 'Fusion Reactor',    baseCost: 3e5,    cm: 1.045, out: 3600,     res: 'en',  tier: 1, cgUp: 180 },
  ...
  // TYPE 2
  { id: 'colony_world',     name: 'Colony World',      baseCost: 1e9,    cm: 1.045, out: 4.5e6,    res: 'cr',  tier: 2, cgUp: 2.25e5 },
  ...
  { id: 'dyson_swarm',      name: 'Dyson Swarm',       baseCost: 2e9,    cm: 1.045, out: 7.2e6,    res: 'en',  tier: 2, cgUp: 3.60e5 },
...
describe('full playthrough — Type 0 to Type 5', () => {
  it('smart player earns and buys through all tiers', () => {
    ...
    phase('Mid T0',           [['orbital_factory', 5], ['fission_plant', 5], ['consumer_factory', 2]])
    ...
    phase('Mid T1',           [['megacorp_hq', 3], ['helium3', 3], ['industrial_cplx', 2]])
    ...
    phase('Mid T2',           [['matter_synth', 3], ['star_lifter', 3], ['stellar_forge_cg', 2]])
    ...
    phase('Mid T3',           [['intergal_consort', 3], ['dark_matter_r', 3], ['gal_fabricator', 2]])
